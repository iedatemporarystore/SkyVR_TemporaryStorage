if getgenv().HATDROP then loadstring(game:HttpGet("https://raw.githubusercontent.com/iedatemporarystore/SkyVR_TemporaryStorage/refs/heads/main/SkyVRFullbodyHatdrop.lua"))() end
